...
const Principles = () => {
  return (
    <motion.section
      ...
      className="h-screen bg-blue-400 py-30 overflow-hidden relative flex flex-col justify-center items-center"
    >
      <div className="w-max-6xl text-blue-600 font-bold text-[100px] leading-none flex flex-col justify-between text-justify gap-3">
        <motion.h1 className="text-[180px] text-white">Self-Learner</motion.h1>
